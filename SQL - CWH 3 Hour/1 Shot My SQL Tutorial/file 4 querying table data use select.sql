-- create database named "main"
-- CREATE DATABASE main;

-- select database to run query
USE main;
...
-- select data from table user1 OR querying table data

-- SELECT * FROM user1;
-- SELECT name, id FROM user1;

-- SELECT * FROM user1 WHERE gender="Female";
-- SELECT * FROM user1 WHERE gender="Male";
-- SELECT * FROM user1 WHERE gender<>"Male";
-- SELECT * FROM user1 WHERE gender!="Male";

-- SELECT * FROM user1 WHERE id = 5;
-- SELECT * FROM user1 WHERE id = 25;
-- SELECT * FROM user1 WHERE id = 50;

-- SELECT * FROM user1 WHERE id < 10;
-- SELECT * FROM user1 WHERE id <= 10;

-- SELECT * FROM user1 WHERE date_of_birth < '2000-01-01';
-- SELECT * FROM user1 WHERE date_of_birth BETWEEN '1990-01-01' AND '2000-01-01';
