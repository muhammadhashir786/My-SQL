-- create new database 
-- CREATE DATABASE main3;

-- select this database to run query
USE main3;
...
-- UPDATE user3 SET salary = 45000;  if we run this all data messes, so we use update with "WHERE"

-- UPDATE user3 SET salary=45000 WHERE id=1;
-- select * from user3;

-- UPDATE user3 SET salary=45000, email='aarav@aaravgmail.com' WHERE id=1;
-- select * from user3;

-- UPDATE user3 SET salary=70000 WHERE id=5;
-- select * from user3;

-- UPDATE user3 SET name='Aisha Khan' WHERE email='aisha@example.com';
-- select * from user3;

-- UPDATE user3 SET salary=salary+10000 WHERE salary<60000;
-- select * from user3;

-- UPDATE user3 SET salary=salary+10000 WHERE salary<60000;
-- select * from user3;

-- UPDATE user3 SET gender='Other' WHERE name='Ishaan';
-- select * from user3;