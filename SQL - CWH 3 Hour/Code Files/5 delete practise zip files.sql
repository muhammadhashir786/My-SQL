-- 1. copy first script file

-- 2. use database 
USE startersql;

-- 3. print or select all columns from table 
-- SELECT * from users;

-- 4. delete table from database
-- DROP TABLE users;

-- 5. print table (table will not print because it was deleted 
-- SELECT * from users;
...
-- 7. print/select this table (only columns will print because there is no data in table)
-- SELECT * from users;
...
-- 9. print all data from table
-- SELECT * from users;

-- 10. delete all columns where salary less than 60000

-- DELETE FROM users WHERE salary<60000;
-- SELECT * from users;

-- 11. delete all columns where salary = null
